...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full relative z-10 pt-40 pb-20 md:pt-32">
        <div className="max-w-4xl space-y-8 md:space-y-10">
          ...
          <div className="space-y-2">
            <motion.h1 
              ...
              className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-[900] text-slate-900 dark:text-white leading-[1.1] tracking-tight"
            >
              SI PEKERJA <br />
              <span className="text-[#1EB2A6] relative inline-block">
               NTT
                <motion.span 
                  ...
                  className="absolute -bottom-2 left-0 h-1 md:h-1.5 bg-[#1EB2A6]/30 rounded-full"
                />
              </span>
            </motion.h1>
          </div>
          ...
          <motion.p 
            ...
            className="text-base md:text-xl text-slate-500 dark:text-slate-400 max-w-2xl leading-relaxed font-medium italic"
          >
            Media digital pengelolaan dan penyimpanan data penempatan tenaga kerja yang berfungsi sebagai pengarsipan data per perusahaan, penyalur tenaga kerja dan rekapitulasi data tenaga kerja secara digital.
          </motion.p>
          ...
          >
            ...
            <a 
              href="https://drive.google.com/drive/folders/1ZXou0vBp52PmdjYtnvjZgUlc_v2epOX7"
              target="_blank"
            ...
            >
              ...
              <span className="text-xs font-black uppercase tracking-widest text-slate-800 dark:text-white group-hover:text-[#1EB2A6] transition-colors">Pelajari Lebih Lanjut</span>
            </a>
          </motion.div>
        </div>
      </div>
