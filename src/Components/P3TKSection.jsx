        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-slate-900 dark:text-white uppercase leading-tight">
                P3TK & <span className="text-[#1EB2A6]">OPP</span>
              </h2>
            </div>

            <p className="text-base md:text-lg text-slate-500 dark:text-slate-400 leading-relaxed italic">
            ...
            <div className="space-y-6">
              <div className="p-6 md:p-8 bg-white dark:bg-slate-800 shadow-xl border-l-4 border-[#1EB2A6] rounded-r-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {objectives.map((text, i) => (
                    <div key={i} className="flex gap-3 items-start">
                      ...
                      <span className="text-[11px] md:text-xs font-bold text-slate-700 dark:text-slate-300 leading-snug">{text}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-video md:aspect-square bg-gradient-to-br from-[#1EB2A6] to-blue-600 rounded-3xl rotate-3 absolute inset-0 opacity-10" />
            <div className="aspect-video md:aspect-square bg-white dark:bg-slate-800 rounded-3xl shadow-2xl overflow-hidden relative border border-slate-100 dark:border-slate-700 flex flex-col justify-center items-center p-4 md:p-12 text-center group">
               <div className="w-full h-full rounded-2xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center text-[#1EB2A6] group-hover:scale-105 transition-transform duration-500">
